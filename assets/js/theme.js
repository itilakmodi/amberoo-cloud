...
window.theme.fn = {
  ...
  intObs(selector, functionName, intObsOptions, alwaysObserve) {
    ...
    let intersectionObserverOptions = { rootMargin: "0px 0px 200px 0px" };
  ...
  intObsInit(selector, functionName) {
    const $el = document.querySelectorAll(selector);
    const intersectionObserverOptions = { rootMargin: "200px" };
    const observer = new IntersectionObserver((entries) => {
      for (const entry of entries) {
        if (entry.intersectionRatio > 0) {
...
((theme = {}, $) => {
  ...
  $.fn.extend({
    textRotator(options) {
      const defaults = { fadeSpeed: 500, pauseSpeed: 100, child: null };
  ...
  const $noticeTopBar = {
    ...
    events() {
      ...
      self.$closeBtn.on("click", (e) => {
        e.preventDefault();
        self.$body.animate({ "margin-top": 0 }, 300, () => {
          self.$wrapper.remove();
          self.saveCookie();
        });
        if (["absolute", "fixed"].includes(self.$header.css("position"))) {
      ...
      $(".thumb-info-floating-element-wrapper")
        .on("mouseenter", function ({ clientX, clientY }) {
          ...
          $(".thumb-info-floating-element-clone")
            .css({ left: clientX + offset, top: clientY + offset })
            .fadeIn(300);
...
((theme = {}, $) => {
  ...
  $.extend(theme, { PluginAnimatedContent });
...
((theme = {}, $) => {
  ...
  $.extend(theme, { PluginBeforeAfter });
...
((theme = {}, $) => {
  ...
  $.extend(theme, { PluginCarouselLight });
...
((theme = {}, $) => {
  ...
  $.extend(theme, { PluginChartCircular });
...
((theme = {}, $) => {
  ...
  $.extend(theme, { PluginCursorEffect });
...
((theme = {}, $) => {
  ...
  $.extend(theme, { PluginFloatElement });
...
((theme = {}, $) => {
  ...
  PluginGDPR.defaults = { cookieBarShowDelay: 3000, expires: 365 };
  $.extend(theme, { PluginGDPR });
...
((theme = {}, $) => {
  ...
  $.extend(theme, { PluginGDPRWrapper });
...
((theme = {}, $) => {
  ...
  $.extend(theme, { PluginHoverEffect });
...
((theme = {}, $) => {
  ...
  $.extend(theme, { PluginInViewportStyle });
...
((theme = {}, $) => {
  ...
  $.extend(theme, { PluginMatchHeight });
...
((theme = {}, $) => {
  ...
  $.extend(theme, { PluginProgressBar });
...
((theme = {}, $) => {
  ...
  $.extend(theme, { PluginRandomImages });
        ...
        self.options.wrapper
          ...
          .on("click", function (e) {
            ...
            setTimeout(() => {
              self.options.wrapper
                .height(self.options.wrapper[0].scrollHeight)
                .animate({ height: self.options.maxHeight }, () => {
                  $this
                    .html(self.options.buttonOpenLabel)
...
((theme = {}, $) => {
  ...
  $.extend(theme, { PluginRevolutionSlider });
...
((theme = {}, $) => {
  ...
  $.extend(theme, { PluginSectionScroll });
...
((theme = {}, $) => {
  ...
  class PluginSticky {
    ...
    events() {
      ...
      const class_to_check = self.options.wrapper.hasClass(
...
((theme = {}, $) => {
      ...
      if ($playButton.get(0)) {
        ...
        self.options.wrapper.find(".video-background-play").on("click", (e) => {
          ...
          if ($playWrapper.get(0)) {
            $playWrapper.animate({ opacity: 0 }, 300, () => {
              $playWrapper.parent().height($playWrapper.outerHeight());
              $playWrapper.remove();
            });
          } else {
            $playButton.animate({ opacity: 0 }, 300, () => {
              $playButton.remove();
            });
          }
          setTimeout(() => {
  ...
  $.extend(theme, { PluginVideoBackground });
  ...
  $.extend(theme, {
    Search: {
      ...
      build() {
        ...
        this.$wrapper.validate({ errorPlacement(error, element) {} });
        theme.fn.execOnceTroughEvent(
          "#header",
...
const snackbar = (text) => {
  const options = {
      text: text, duration: 5000, pos: 'top-center', actionTextColor: '#EB1616',
